...
export function AssigmentRow({
    ...
    return (
        <div className="grid grid-cols-14 py-2 px-3 text-sm hover:bg-slate-800/50">
            ...
            <div className={`text-pink-300 flex items-center justify-center cursor-pointer`} >
                <Pencil size={20} />
            </div>
...
export function BusDailyAssignment() {
    ...
    useEffect(() => {
        window.electron.buses.getDailyBusAssignments(1, '5/1/2026').then(resp => {
            console.log(resp);
            ...
            <CardHeader className="border-b border-slate-700/50 pb-3">
                <div className="flex items-center justify-between">
                    <CardTitle className="text-slate-100 flex items-center text-2xl">
                        <ArrowUp01 className="mr-2 h-5 w-5 text-cyan-500" />
                        Asignación de número de vehículo
                    </CardTitle>
                    ...
                    <Tabs defaultValue="assignments" className="w-full">
                        ...
                        <TabsContent value="assignments" className="mt-0">
                            <div className="bg-slate-800/30 rounded-lg border border-slate-700/50 overflow-hidden">
                                <div className="grid grid-cols-14 text-xs text-slate-400 p-3 border-b border-slate-700/50 bg-slate-800/50">
                                    <div className="col-span-1"># vehículo</div>
                                    <div className="col-span-4">Modelo</div>
                                    <div className="col-span-2">Año</div>
                                    <div className="col-span-2">Placas</div>
